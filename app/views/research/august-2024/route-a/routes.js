...
// Country
router.post('/august-2024/route-a/where-you-live', function (req, res) {
...
// Scotland or Wales
router.post('/august-2024/route-a/gp-in-scotland-or-wales', function (req, res) {
...
router.post('/august-2024/route-a/live-in-highlands', function (req, res) {
...
// Date of birth
router.post('/august-2024/route-a/date-of-birth', function (req, res) {
...
// Partner
router.post('/august-2024/route-a/partner', function (req, res) {
...
// Benefits
router.post('/august-2024/route-a/claim-benefits-tax-credits', function (req, res) {
...
// Universal credit
router.post('/august-2024/route-a/universal-credit', function (req, res) {
...
router.post('/august-2024/route-a/universal-credit-claim', function (req, res) {
...
router.post('/august-2024/route-a/universal-credit-take-home-pay', function (req, res) {
...
router.post('/august-2024/route-a/benefits', function (req, res) {
...
// Tax credits
router.post('/august-2024/route-a/tax-credit-type', function (req, res) {
...
// Tax credits income
router.post('/august-2024/route-a/tax-credit-income', function (req, res) {
...
router.post('/august-2024/route-a/employment-support-allowance-type', function (req, res) {
...
router.post('/august-2024/route-a/jobseekers-allowance-type', function (req, res) {
...
// Pension credit type
router.post('/august-2024/route-a/pension-credit-type', function (req, res) {
...
router.post('/august-2024/route-a/pregnant-or-given-birth', function (req, res) {
...
// War pensioner
router.post('/august-2024/route-a/war-pensioner', function (req, res) {
...
// Diabetes
router.post('/august-2024/route-a/diabetes', function (req, res) {
...
// Diabetes medication
router.post('/august-2024/route-a/diabetes-medication', function (req, res) {
...
router.post('/august-2024/route-a/list-of-medical-conditions', function (req, res) {
...
// Glaucoma
router.post('/august-2024/route-a/glaucoma', function (req, res) {
...
// Care home
router.post('/august-2024/route-a/care-home', function (req, res) {
...
router.post('/august-2024/route-a/local-council-assessed', function (req, res) {
...
// Savings
router.post('/august-2024/route-a/savings', function (req, res) {
