...
// Scotland or Wales
router.post(
  "/august-2024/route-a/gp-in-scotland-or-wales",
  function (req, res) {
...
// Benefits
router.post(
  "/august-2024/route-a/claim-benefits-tax-credits",
  function (req, res) {
...
router.post(
  "/august-2024/route-a/universal-credit-take-home-pay",
  function (req, res) {
...
router.post(
  "/august-2024/route-a/employment-support-allowance-type",
  function (req, res) {
    var benefits = req.session.data["benefits"];
...
router.post(
  "/august-2024/route-a/jobseekers-allowance-type",
  function (req, res) {
    var benefits = req.session.data["benefits"];
...
router.post(
  "/august-2024/route-a/pregnant-or-given-birth",
  function (req, res) {
...
router.post(
  "/august-2024/route-a/list-of-medical-conditions",
  function (req, res) {
