...
// Scotland or Wales
router.post('/august-2024/route-b/gp-in-scotland-or-wales', function (req, res) {
...
// Benefits
router.post('/august-2024/route-b/claim-benefits-tax-credits', function (req, res) {
...
router.post('/august-2024/route-b/universal-credit-take-home-pay', function (req, res) {
...
router.post('/august-2024/route-b/employment-support-allowance-type', function (req, res) {
...
router.post('/august-2024/route-b/jobseekers-allowance-type', function (req, res) {
...
router.post('/august-2024/route-b/pregnant-or-given-birth', function (req, res) {
...
router.post('/august-2024/route-b/list-of-medical-conditions', function (req, res) {
