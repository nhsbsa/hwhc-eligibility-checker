...
// Scotland or Wales
router.post('/check-for-help-paying-nhs-costs/gp-in-scotland-or-wales', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/live-in-highlands', function (req, res) {
...
// Partner
router.post('/check-for-help-paying-nhs-costs/partner', function (req, res) {
...
// Pension credit
router.post('/check-for-help-paying-nhs-costs/pension-credit', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/universal-credit-take-home-pay', function (req, res) {
...
// Tax credits income
router.post('/check-for-help-paying-nhs-costs/tax-credit-income', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/employment-support-allowance-type', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/jobseekers-allowance-type', function (req, res) {
...
// Pension credit type
router.post('/check-for-help-paying-nhs-costs/pension-credit-type', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/pregnant-or-given-birth', function (req, res) {
...
// War pensioner
router.post('/check-for-help-paying-nhs-costs/war-pensioner', function (req, res) {
...
// Diabetes
router.post('/check-for-help-paying-nhs-costs/diabetes', function (req, res) {
...
// Diabetes medication
router.post('/check-for-help-paying-nhs-costs/diabetes-medication', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/list-of-medical-conditions', function (req, res) {
...
// Glaucoma
router.post('/check-for-help-paying-nhs-costs/glaucoma', function (req, res) {
...
// Care home
router.post('/check-for-help-paying-nhs-costs/care-home', function (req, res) {
...
router.post('/check-for-help-paying-nhs-costs/local-council-assessed', function (req, res) {
...
// Savings
router.post('/check-for-help-paying-nhs-costs/savings', function (req, res) {
